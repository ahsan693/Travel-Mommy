...
export default function Widget({ data = widgetData }: { data?: WidgetData }) {
  return (
    <div className="mx-auto flex w-full max-w-[1216px] flex-col items-center justify-center rounded-[24px] bg-[#FFFFFF] p-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
      
      {/* Inner Content Wrapper */}
      <div className="flex w-full max-w-[1160.78px] flex-col gap-[10px]">
        ...
        {/* Main Inputs Row */}
        <div className="relative flex w-full flex-col gap-[10px] lg:flex-row lg:items-center">
